...
class ApplicationMain {
	...
	public static function main () {
		...
		//nme.Lib.setPackage("VitaL", "Example1", "mapbit.Example1", "1.0.0");
	...
	private static function start ():Void {
		...
		var hasMain = false;
		var mainClass = Type.resolveClass ("mapbit.Main");
...
class ApplicationMain {
	...
	public static function main () {
		...
		for (methodName in Type.getClassFields (mapbit.Main)) {
		...
		if (hasMain) {
			...
			Reflect.callMethod (mapbit.Main, Reflect.field (mapbit.Main, "main"), []);
...
@:keep class DocumentClass extends mapbit.Main { }
